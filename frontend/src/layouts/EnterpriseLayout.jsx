                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <div className="relative ml-1" ref={profileRef}>
                                <button
                                    ...
                                    className="hidden lg:flex items-center gap-1.5 group focus:outline-none"
                                >
                                    {userImageUrl ? (
                                        <img
                                            src={userImageUrl}
                                            alt={userName}
                                            className="w-8 h-8 rounded-[8px] object-cover ring-2 ring-white/[0.08] hover:ring-violet-500/40 transition-all duration-200 shadow-md shadow-violet-500/10"
                                        />
                                    ) : (
                                        <div className="w-8 h-8 rounded-[8px] bg-gradient-to-br from-violet-500 to-indigo-600 flex items-center justify-center text-white font-semibold text-[11px] shadow-md shadow-violet-500/20 group-hover:shadow-violet-500/40 transition-all duration-200 ring-2 ring-white/[0.08] group-hover:ring-violet-500/40">
                                            {userInitials}
                                        </div>
                                    )}
                                    <ChevronDown className={`w-3.5 h-3.5 text-gray-400/70 group-hover:text-white transition-all duration-200 ${profileOpen ? 'rotate-180' : ''}`} />
                                </button>
                                ...
                                <AnimatePresence>
                                    {profileOpen && (
                                        <motion.div
                                            ...
                                            className="absolute right-0 top-[calc(100%+8px)] w-64 rounded-xl bg-[#0d1117] border border-white/[0.08] shadow-2xl shadow-black/40 backdrop-blur-xl overflow-hidden z-50"
                                        >
                                            {/* User Info */}
                                                ...
                                                <div className="flex items-center gap-3">
                                                    {userImageUrl ? (
                                                        <img
                                                            src={userImageUrl}
                                                            alt={userName}
                                                            className="w-10 h-10 rounded-[10px] object-cover ring-2 ring-white/[0.08]"
                                                        />
                                                    ) : (
                                                        <div className="w-10 h-10 rounded-[10px] bg-gradient-to-br from-violet-500 to-indigo-600 flex items-center justify-center text-white font-semibold text-[14px] shadow-md shadow-violet-500/20">
                                                            {userInitials}
                                                        </div>
                                                    )}
                                                    <div className="flex-1 min-w-0">
                                                        <p className="text-[14px] font-semibold text-white/90 truncate leading-tight">{userName}</p>
                                                        <p className="text-[11px] text-gray-400/70 truncate leading-tight">{userEmail}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="py-1.5">
                                                <button
                                                    ...
                                                    className="flex items-center gap-2.5 w-full px-4 py-2.5 text-[13px] text-gray-300/80 hover:text-white hover:bg-white/[0.04] transition-colors duration-150"
                                                >
                                                ...
                                                <button
                                                    ...
                                                    className="flex items-center gap-2.5 w-full px-4 py-2.5 text-[13px] text-gray-300/80 hover:text-red-400 hover:bg-red-500/[0.06] transition-colors duration-150"
                                                >
